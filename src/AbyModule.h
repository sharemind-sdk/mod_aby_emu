...
#ifndef MOD_ABY_EMU_SHARED3PMODULE_H
#define MOD_ABY_EMU_SHARED3PMODULE_H
...
class SHAREMIND_VISIBILITY_INTERNAL AbyModule {

public: /* Methods: */

    AbyModule(const LogHard::Logger & logger,
...
#endif /* MOD_ABY_EMU_SHARED3PMODULE_H */
