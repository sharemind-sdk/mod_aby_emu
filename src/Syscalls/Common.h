...
#ifndef MOD_ABY_EMU_SYSCALLS_COMMON_H
#define MOD_ABY_EMU_SYSCALLS_COMMON_H
 ...
 */
static constexpr size_t ABY_EMU_INDEX = 0u;
using VMHandles = PdpiVmHandles<ABY_EMU_INDEX>;
...
template <>
inline uint8_t getStack<aby_uint8_t>(const SharemindCodeBlock & arg)
{ return arg.uint8[0]; }
template <>
inline uint16_t getStack<aby_uint16_t>(const SharemindCodeBlock & arg)
{ return arg.uint16[0]; }
template <>
inline uint32_t getStack<aby_uint32_t>(const SharemindCodeBlock & arg)
{ return arg.uint32[0]; }
template <>
inline uint64_t getStack<aby_uint64_t>(const SharemindCodeBlock & arg)
{ return arg.uint64[0]; }
...
#endif /* MOD_ABY_EMU_SYSCALLS_COMMON_H */
